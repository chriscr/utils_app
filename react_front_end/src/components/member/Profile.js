...
function Profile(){
	...
	function updatePasswordToDB(){
		...
		axios.put('/api/save_password', data, {
			...
			console.log('[updatePasswordToDB - save_password] error: ',error + ' back-end api call error');
				...
				<div className="grid-x">
					...
					<div className="large-6 medium-6 small-12 cell text-left pt-20">
						<table className="unstriped unbordered mb-0">
							<tbody>
							<tr><td className="font-raleway font-weight-400 width-75px pb-20">Name:</td><td className="font-raleway font-weight-600 pb-20">{localStorage.getItem('auth_users_name')}</td></tr>
							<tr><td className="font-raleway font-weight-400 width-75px pb-20">Email:</td><td className="font-raleway font-weight-600 pb-20">{localStorage.getItem('auth_email')}</td></tr>
							<tr><td className="font-raleway font-weight-400 width-75px pb-20">Role:</td><td className="font-raleway font-weight-600 pb-20">{localStorage.getItem('auth_role')}</td></tr>
						...
						<div>
							<div className="clearfix">
				                ...
				                {disable ? (
									...
									<Link onClick={handleUpdate} className="icon-with-text hover-opacity-50 no-underline">
