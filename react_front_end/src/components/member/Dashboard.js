				...
				<div className="grid-x">
					...
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/member/check_list" className="icon-with-text hover-opacity-50 no-underline">
							<img src={check_list_icon} className="" width="40" alt="check list"/> <span className="txt-blue">CHECK LIST</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/member/portfolio" className="icon-with-text hover-opacity-50 no-underline">
							<img src={portfolio_icon} className="" width="50" alt="portfolio"/> <span className="txt-blue">PORTFOLIO</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/member/traffic" className="icon-with-text hover-opacity-50 no-underline">
							<img src={location_finder_icon} className="" width="40" alt="traffic incidents"/> <span className="txt-blue">TRAFFIC</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/member/weather" className="icon-with-text hover-opacity-50 no-underline">
							<img src={weather_icon} className="br-5" width="42" alt="weather"/> <span className="txt-blue">WEATHER</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/member/videos" className="icon-with-text hover-opacity-50 no-underline">
							<img src={videos_icon} className="br-5" width="42" alt="videos"/> <span className="txt-blue">VIDEOS</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/member/payments" className="icon-with-text hover-opacity-50 no-underline">
							<img src={payments_icon} className="br-5" width="42" alt="payments"/> <span className="txt-blue">PAYMENTS</span>
						</Link>
					</div>
				</div>
			</div>
