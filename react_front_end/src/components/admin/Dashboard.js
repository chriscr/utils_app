				...
				<div className="grid-x">
					...
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/admin/users" className="icon-with-text hover-opacity-50 no-underline">
							<img src={users_icon} className="" width="40" alt="save items"/> <span className="txt-blue">USERS</span>
						</Link>
					</div>
					
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/admin/check_list" className="icon-with-text hover-opacity-50 no-underline">
							<img src={check_list_icon} className="" width="40" alt="save items"/> <span className="txt-blue">CHECK LIST</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/admin/portfolio" className="icon-with-text hover-opacity-50 no-underline">
							<img src={portfolio_icon} className="" width="50" alt="save items"/> <span className="txt-blue">PORTFOLIO</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/admin/traffic" className="icon-with-text hover-opacity-50 no-underline">
							<img src={location_finder_icon} className="" width="40" alt="save items"/> <span className="txt-blue">TRAFFIC</span>
						</Link>
					</div>
					<div className="large-3 medium-4 small-6 cell text-left pt-20">
						<Link to="/admin/weather" className="icon-with-text hover-opacity-50 no-underline">
